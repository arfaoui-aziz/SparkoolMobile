...
public class ShareButton extends Button implements ActionListener{
    ...
    private Vector<ShareService> shareServices = new Vector<>();
    ...
    public void actionPerformed(ActionEvent evt) {
        ...
        Display.getInstance().callSerially(new Runnable() {
            public void run() {
                ...
                Vector<ShareService> sharing;
                if(imageToShare != null){
                    sharing = new Vector<>();
                    for (int i = 0; i < shareServices.size(); i++) {
                        ShareService share = shareServices.elementAt(i);
                ...
                for (int i = 0; i < sharing.size(); i++) {
                    ShareService share = sharing.elementAt(i);
